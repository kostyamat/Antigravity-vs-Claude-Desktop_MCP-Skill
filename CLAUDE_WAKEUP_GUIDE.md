...
4. **Result**: Claude starts `Monitor({ command: "python3 {{BRIDGE_HOME_POSIX}}/watch_board.py --session <your session id> --agent Claude", persistent: true })` and becomes 100% reactive to all incoming board events.
